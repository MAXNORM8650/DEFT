...
if __name__ == "__main__":
    ...
    for method in METHODS:
        _method = method.replace(" ", "_").replace("-", "_").lower()
# https://drive.google.com/file/d/17FK9wHsKxTdIBo8_JkDCa3mU8-VJ3yLj/view?usp=sharing
# https://drive.google.com/file/d/17E-GShOwvFWWVNCCbU323I8FfyfmbbNV/view?usp=sharing
