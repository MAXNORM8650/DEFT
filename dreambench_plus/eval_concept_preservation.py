...
def main(
    ...
    method: str = "DreamBooth deft SDXL",
    out_dir: str = "data_gpt_rating/concept_preservation_full/dreambooth_deft_sdxl",
...
# python eval_concept_preservation.py --method "DreamBooth deft SDXL" \
# --out_dir data_gpt_rating/concept_preservation_full/dreambooth_deft_sdxl \
# --category subject \
# --ablation_settings full